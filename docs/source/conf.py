...
# numerai_signals_kedro documentation build
...
from numerai_signals_kedro import __version__ as release

# -- Project information -----------------------------------------------------

project = "numerai_signals_kedro"
copyright = "2020, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "numerai_signals_kedrodoc"
...
latex_documents = [
    (
        master_doc,
        "numerai_signals_kedro.tex",
        "numerai_signals_kedro Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "numerai_signals_kedro",
        "Project numerai_signals_kedro codebase.",
        "Data-Science",
    )
]
